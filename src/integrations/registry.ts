...
export const integrationCatalog: IntegrationCatalogEntry[] = [
  ...
  },
  {
    ...
    description: 'Publish semantic HTML5 articles or newsletters through the WordPress REST API. Credentials use a WordPress application password, never the normal account password.',
    categoryLabel: 'Publishing · Websites',
    permissions: permissions('document.read', 'metadata.read', 'files.read', 'files.write'),
  ...
  },
  {
    ...
    description: 'Publish semantic HTML5 to a site implementing the omi-newsletter-publish/1 JSON contract with Bearer, X-API-Key, Basic, or no authentication.',
    categoryLabel: 'Publishing · Websites',
    permissions: permissions('document.read', 'metadata.read', 'files.read', 'files.write'),
