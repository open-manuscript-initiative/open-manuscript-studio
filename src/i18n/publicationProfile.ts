...
const en: PublicationProfileCopy = {
  ...
  experimental: 'Studio implementation profile for OMI-SPEC-240@0.1.0 Draft. Implementation coverage is documented separately; this is not a formal conformance claim.',
...
const hu: PublicationProfileCopy = {
  ...
  experimental: 'Stúdió implementációs profil az OMI-SPEC-240@0.1.0 Draft alapján. Az implementációs lefedettség külön dokumentált; ez nem formális megfelelőségi állítás.',
...
const de: PublicationProfileCopy = {
  ...
  experimental: 'Studio-Implementierungsprofil für OMI-SPEC-240@0.1.0 Draft. Die Implementierungsabdeckung ist separat dokumentiert; dies ist keine formale Konformitätsaussage.',
