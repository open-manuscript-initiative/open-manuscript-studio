    ...
    <section className="studio-menu-view omi-categorized-reference-lists-panel">
      ...
      <div className="studio-tool-card"><div style={{ width: '100%' }}>
        ...
        <div className="studio-tool-actions">
          <input value={newListTitle} onChange={(event) => setNewListTitle(event.target.value)} onKeyDown={(event) => { if (event.key === 'Enter') createList(); }} />
      ...
      {active ? <>
        <div className="studio-tool-card"><div style={{ width: '100%' }}>
          ...
          <div className="studio-manuscript-fields">
            ...
            <label><span>{copy.resourceTypes}</span><input value={customTypes} onChange={(event) => setCustomTypes(event.target.value)} /></label>
          </div>
