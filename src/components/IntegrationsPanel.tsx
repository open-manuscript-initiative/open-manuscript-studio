      ...
      {isPublishing && expanded ? (
        <div className="omi-integration-config">
          ...
          <div className="omi-publishing-form">
            ...
            <label><span>{copy.connectionName}</span><input value={publishingName} onChange={(event) => setPublishingName(event.target.value)} /></label>
            <label><span>{copy.baseUrl}</span><input type="url" value={publishingBaseUrl} onChange={(event) => setPublishingBaseUrl(event.target.value)} /></label>
            <div className="omi-integration-card__actions">
