...
- Current beta build number: `12`
- Public Studio development line: `0.2.0-beta.4`

The numeric Apple short version is intentionally separated from the prerelease label because Apple bundle version fields require store-compatible version values. The Studio UI and release metadata identify this development line as `0.2.0-beta.4` while the Apple short version remains numeric.
