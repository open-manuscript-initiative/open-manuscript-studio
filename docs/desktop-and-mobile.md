...
The iOS-specific Tauri configuration uses the bundle identifier `org.openmanuscript.studio`, minimum system version 14.0, App Store short version `0.3.0` and build number `13`. The Studio release line is `0.3.0-beta.1` in product/release metadata.
