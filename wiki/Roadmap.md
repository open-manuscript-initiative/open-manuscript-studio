...
Open Manuscript Studio is on the `0.2.0-beta.3` final stabilization beta line. The authoring, account, review, import/export, native packaging, and institutional administration layers are implemented; the next milestone is a stable release candidate.
