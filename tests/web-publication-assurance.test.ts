...
test('peer-reviewed seal carries only revision-bound editorial evidence, never reviewer identity', async () => {
  ...
  assert.ok(artifact.html.includes(publicationVenueAuthority.venueId));
  assert.ok(artifact.html.includes(publicationVenueAuthority.domain));
  assert.ok(artifact.html.includes(publicationVenueAuthority.verificationId));
  assert.ok(artifact.html.includes(publicationVenueAuthority.verifiedAt));
  assert.ok(artifact.html.includes(publicationVenueAuthority.editorRole));
