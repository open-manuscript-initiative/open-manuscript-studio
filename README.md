...
> **Current status:** `0.2.0-beta.3` · final stabilization beta.
>
...
- 47 selectable UI locales across every shared web/desktop/mobile build, covering all 49 Google Play locale entries through canonical regional mapping; every canonical locale has a PO catalogue, reviewed translations are preserved, and Google Play App strings translation can backfill remaining untranslated entries through the audited completion-overlay workflow;
